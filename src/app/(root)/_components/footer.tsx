...
import { socialLinks } from "@/lib/data/navbar";
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="order-1 md:order-2 text-center">
                        <p className="text-sm text-muted-foreground">
                            © {currentYear} <span className="font-medium text-foreground">Aman Shams</span>. All rights reserved.
                        </p>
                    </div>
                    ...
                    <div className="order-3 flex items-center gap-3">
                        {socialData.map((social) => (
                            <Link
                                ...
                                className="size-9 rounded-full bg-muted/50 hover:bg-muted flex items-center justify-center transition-all hover:scale-110"
